function [thrustvec, phase1_end, phase2_end] = thrustvecfunc2(t,data)

global discharge_coeff volume_bottle p_amb gamma area_throat  gas_const_air ...
    mass_air_0 volume_air_0 p_abs_0;
    ...
    for i = 1:length(t)
        ...
        mass_air = data(i,8); % mass of the air
        volume_air = data(i,9); % volume of air
